...
// L'importation de AdvancedFilters est supprimée car le composant est dans ce fichier
import { ClassificationEvent, TypeEvent, type Incident } from "@/lib/data/incidents-data"
import { getClassificationString, getTypeColor } from "@/lib/utils"
...
export function IncidentsTable() {
    ...
    // const router = useRouter() // Remplacé par le stub
